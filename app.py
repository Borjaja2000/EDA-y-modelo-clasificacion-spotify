...
st.set_page_config(page_title="Spotify", page_icon=":music:",layout="wide") #configuración de la página

#Cargar datos
listings = pd.read_csv("spotify_data_clean.zip", low_memory=False)
...
if pestaña == "Inicio":
    ...
    with tabsVecindario[2]:
        ...
        calendar_data = calendar_data.sample(frac=0.5)
